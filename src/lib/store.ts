...
// Distinct key: EngLingo and Idoialingo share the github.io origin, so they
// MUST NOT share localStorage. Different keys keep their progress separate.
const KEY = 'englingo:v1';
